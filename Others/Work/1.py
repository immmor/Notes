...
df = pd.read_excel('/Users/mrok/Documents/coder/funtext/Web/Notes/Work/Connectivity.xlsm', sheet_name='Sheet')
print(df)
...
H.htmlcontent
H.save_file('highcharts.html')

import subprocess
subprocess.run(['open', 'highcharts.html'])