...
class Client:
    ...
    def __init__(self, use_proxy=False):
        self.cookie = '39d24c6a-abb4-43ea-ba17-a10805f10a8c'
    ...
    def get_organization_id(self):
        url = "https://claudeai.ai/api/organizations"

        headers = {
            'User-Agent':
                'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/115.0',
            'Accept-Language': 'en-US,en;q=0.5',
            'Referer': 'https://claudeai.ai/chats',
    ...
    def list_all_conversations(self):
        url = f"https://claudeai.ai/api/organizations/{self.organization_id}/chat_conversations"
    ...
    def send_message(self, prompt, conversation_id, attachment=None):
        url = "https://claudeai.ai/api/append_message"
    ...
    def delete_conversation(self, conversation_id):
        url = f"https://claudeai.ai/api/organizations/{self.organization_id}/chat_conversations/{conversation_id}"
    ...
    def upload_attachment(self, file_path):
        ...
        url = 'https://claudeai.ai/api/convert_document'
        headers = {
            'User-Agent':
                'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/115.0',
            'Accept-Language': 'en-US,en;q=0.5',
    ...
    def rename_chat(self, title, conversation_id):
        url = "https://claudeai.ai/api/rename_chat"
